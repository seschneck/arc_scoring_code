...
dS$BFI_EXT = varScore(dI, Forward= c('BFI1', 'BFI11', 'BFI16','BFI26', 'BFI36'), Reverse= c('BFI6', 'BFI21', 'BFI31'), Range = c(1,5) )
...
dS$BAI_OPEN = varScore(dI, Forward= c('BFI5', 'BFI10', 'BFI15', 'BFI20', 'BFI25', 'BFI30', 'BFI40', 'BFI44'), Reverse= c('BFI35', 'BFI41'), Range = c(1,5) )
